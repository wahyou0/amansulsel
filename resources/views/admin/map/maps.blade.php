    ...
    <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
        <div class="statbox widget box box-shadow">
            <div class="row mb-3">
                ...
                <form action="{{ url('map/store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('kord')
                                    is-invalid
                                @enderror" name="kord" id="kordinat">
                                @error('kord')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="deskripsi" cols="30" rows="15" required></textarea>
                        </div>
                    </div>
                    {{-- <div class="row mb-3">
                        <label class="col-sm-2"> Deskripsi </label>
