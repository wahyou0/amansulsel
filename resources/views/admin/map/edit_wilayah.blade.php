...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/leaflet.draw/1.0.4/leaflet.draw.css" integrity="sha512-gc3xjCmIy673V6MyOAZhIW93xhM9ei1I+gLbmFjUHIjocENRsLX/QUE1htk5q1XV2D/iie/VQ8DXI6Vu8bexvQ==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <div id="flHorizontalForm" class="col-lg-12 layout-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <form action="{{ url('draw/update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select id="PD" class="form-control @error('nama_pd')
                                is-invalid
                            @enderror" placeholder="Select a person..." autocomplete="off" name="nama_pd">
                            @error('nama_pd')
                ...
                <div class="row mb-3">
                    <label class="col-sm-2">Nama Komunitas</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2"> Kordinat WIlayah </label>
                    <div class="col-sm-10">
                        <textarea class="form-control" name="draw" id="polygon" cols="30" rows="10" required></textarea>
                    </div>
                </div>
                {{-- <div class="row mb-3">
                    <label class="col-sm-2">Kordinat WIlayah</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="draw" value="{{ $data->polygon }}">
                    </div>
                </div> --}}
...
<script>
   ...
   var Thunderforest_Landscape = L.tileLayer('https://{s}.tile.thunderforest.com/landscape/{z}/{x}/{y}.png?apikey={apikey}', {
    ...
    @foreach ($draw as $gambar )
        var drawnItems = L.geoJson(<?php echo $gambar; ?>).addTo(map);
